...
int main(int argc, char** argv) {
	...
	printf("connected is %b a board\n", wiimotes[0]->type == EXP_WII_BOARD);
	printf("connected is %b a motion plus\n", wiimotes[0]->type == EXP_MOTION_PLUS);
	printf("connected is %b a nunchuck\n", wiimotes[0]->type == EXP_NUNCHUK);
	printf("connected is %b a classic\n", wiimotes[0]->type == EXP_CLASSIC);
	printf("connected is %b a mp nunchuck\n", wiimotes[0]->type == EXP_MOTION_PLUS_NUNCHUK);
	printf("connected is %b a nothing\n", wiimotes[0]->type == EXP_NONE);
